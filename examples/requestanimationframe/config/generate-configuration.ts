...
initActionCreator
  ...
  initActionCreator = customFactory.createInitAction("MainTitleForLabel");
  initActionCreator
    .addStartOperationByType(selectElement, { selector: "[data-id-for]" })
    .addStartOperationByType(getControllerInstance, {
      systemName: "LabelController",
    })
    .addStartOperationByType(addControllerToElement, {
      labelId: "mainTitleFor",
    } as any)
    .addEndOperationByType(selectElement, { selector: "[data-id-for]" })
    .addEndOperationByType(removeControllerFromElement, {
      controllerName: "LabelController",
    });
  ...
  customFactory
    .createTimelineAction(TIMELINE_TITLE, "AddGreeting")
    .addDuration(20)
    .addStartOperationByType(selectElement, {
    ...
    .addStartOperationByType(createElement, {
      elementName: "span",
      text: "globaldata.queryParams.username",
    })
    .addStartOperationByType(setElementContent, {})
    .addStartOperationByType(selectElement, {
      selector: ".greeter",
    })
    .addStartOperationByType(setStyle, {
      properties: {
        display: "block",
      },
    })
